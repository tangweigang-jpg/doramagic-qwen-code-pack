...
This repository is an independent Doramagic AI context resource pack for QwenLM/qwen-code.
...
Do not use this repository as the upstream project's support tracker. If the bug is in QwenLM/qwen-code itself, report it to https://github.com/QwenLM/qwen-code/issues first and link the upstream issue here only when it changes this pack.
