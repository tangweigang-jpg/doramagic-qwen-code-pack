...
This repository is an independent AI context resource pack for QwenLM/qwen-code. It is not Qwen Code's official security contact.
...
Upstream product vulnerabilities should be reported to QwenLM/qwen-code's own security policy. Link the upstream advisory here only when this pack needs a mitigation or warning.
